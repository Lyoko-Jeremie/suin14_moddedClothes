	...
	setup.moddedClothes.under_upper = [
		{
			index: 1,
			name: "yong yi",
			name_cap: "yong yi", cn_name_cap: "黑色泳衣",
			variable: "yong yi",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
			...
			colour: 0,
			colour_options: [],
			colour_combat: "pink", exposed: 0,
			exposed_base: 0,
			type: ["school", "swim", "tanLines"],
			set: "under_upper",
			gender: "f",
			femininity: 300,
			warmth: 10,
	...
	
		{
			index: 1,
			name: "aheise",
			name_cap: "aheise", cn_name_cap: "复古泳衣",
			variable: "aheise",
			integrity: 20,
			integrity_max: 20,
			fabric_strength: 20,
	...
	
		{
			index: 1,
			name: "daisy swimsuit",
			name_cap: "Daisy swimsuit", cn_name_cap: "雏菊泳衣",
			variable: "daisyswimsuit",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 30,
			reveal: 500,
			...
			cursed: 0,
			location: 0,
			iconFile: "daisy_swimsuit.png",
			accIcon: 0
		},
	
		{
			index: 2,
			name: "children&#39;s swimsuit",
			name_cap: "children&#39;s swimsuit", cn_name_cap: "儿童泳衣",
			variable: "kidsswimsuit",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 30,
			reveal: 500,
	...
	
		{
			index: 3,
			name: "lace swimsuit",
			name_cap: "lace swimsuit", cn_name_cap: "花边泳装",
			variable: "laceswimsuit",
			integrity: 40,
			integrity_max: 40,
			fabric_strength: 30,
			reveal: 600,
			...
			cursed: 0,
			location: 0,
			iconFile: "lace_swimsuit.png",
			accIcon: 0,
			outfitPrimary: {under_lower: "lace swimsuit bottom"}
		},
	
		{
			index: 1,
			name: "rococo_vest",
			name_cap: "Rococo_vest",
			cn_name_cap: "洛可可背心",
			variable: "rococo_vest",
			integrity_max: 100,
			integrity: 100,
			fabric_strength: 30,
			reveal: 200,
		...
		
		{
				index: 6,
				name: "king milk",
				name_cap: "king milk",cn_name_cap: "皇帝的欧派",
				variable: "kingmilk",
				integrity: 200,
				integrity_max: 200,
				fabric_strength: 15,
