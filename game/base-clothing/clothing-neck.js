	...
	setup.moddedClothes.neck = [
		{
			index: 9,
			name: "dresschoker",
			name_cap: "dresschoker", cn_name_cap: "项链",
			variable: "dresschoker",
			integrity: 40,
			integrity_max: 40,
			fabric_strength: 20,
			reveal: 100,
	...
	
		{
			index: 28,
			name: "pinan fu",
			name_cap: "pinan fu", cn_name_cap: "平安扣和小包",
			variable: "pinan fu",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 20,
	...
	
		{
			index: 17,
			name: "chaotianjiang",
			name_cap: "chaotianjiang", cn_name_cap: "超天酱马尾",
			variable: "chaotianjiang",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 500,
			reveal: 100,
	...
	
		{
			index: 9,
			name: "aerhuan",
			name_cap: "aerhuan", cn_name_cap: "耳饰",
			variable: "aerhuan",
			integrity: 40,
			integrity_max: 40,
			fabric_strength: 20,
	...
	
		{
			index: 201,
			name: "qiannianjimu",
			name_cap: "Qiannianjimu",
			cn_name_cap: "千年积木",
			variable: "qiannianjimu",
			integrity_max: 200,
			integrity: 200,
			fabric_strength: 30,
			reveal: 200,
		...
		{
			index: 1,
			name: "colored lantern necklace",
			name_cap: "Colored lantern necklace", cn_name_cap: "彩灯项链",
			variable: "colored lantern necklace",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 20,
			reveal: 100,
			...
			warmth: 0,
			cost: 3000,
			description: "一串小彩灯做成的项链，甚至可以接电点亮。还有，谁把玻璃珠戴在了耳朵上？",
			shop: ["clothing"],
			collared: 0,
			accessory: 1,
			accessory_colour: 1,
			...
			cursed: 0,
			location: 0,
			iconFile: "colored_lantern_necklace.png",
			accIcon: 0
		},
	...
	
		{
			index: 2,
			name: "shittim chest",
			name_cap: "Shittim chest", cn_name_cap: "什亭之匣",
			variable: "shittimchest",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 20,
			reveal: 100,
			...
			colour_options: [],
			colour_sidebar: 0,
			type: ["sleep", "stealthy", "rainproof", "shade"],
			gender: "n",
			warmth: 0,
			cost: 15000,
			description: "与夏莱终端所连接的阿罗娜和普拉娜将为你提供帮助。“请放心，阿罗娜会保护老师的安全的！”“像前辈说的，交给我们吧，老师。”",
			shop: ["clothing"],
			collared: 0,
			accessory: 0,
			accessory_colour: 0,
	...
	
		{
			index: 2,
			name: "fcxzbb",
			name_cap: "fcxzbb", cn_name_cap: "丰川祥子包包",
			variable: "fcxzbb",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 20,
			...
			warmth: 0,
			cost: 15000,
			description: "死亡再一次把我吐了出来。我已经死了,再多的死亡也不会带来伤痛。”",
			shop: ["clothing"],
			collared: 0,
			accessory: 0,
			accessory_colour: 0,
	...
	
		{
			index: 1,
			name: "mini wraith",
			name_cap: "Mini wraith", cn_name_cap: "背后灵",
			variable: "miniwraith",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 5,
			...
			warmth: -50,
			cost: 200000,
			description: "死寂的阴冷渗入脊髓，提线从未断裂. 你 能够 看到 吗？它 在 这里 . ",
			shop: ["clothing", "forest"],
			collared: 0,
			accessory: 0,
			accessory_colour: 0,
	...
	
		{
			index: 1,
			name: "hat strap",
			name_cap: "Hat strap", cn_name_cap: "帽子绑带",
			variable: "hatstrap",
			integrity: 100,
			integrity_max: 100,
			fabric_strength: 100,
