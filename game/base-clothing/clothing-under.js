	...
	setup.moddedClothes.under_lower = [
		{
			index: 2,
			name: "yong ku",
			name_cap: "yong ku", cn_name_cap: "黑色泳裤",
			name_simple: "yong ku",
			variable: "yong ku",
			integrity: 20,
			integrity_max: 20,
	...
	
		{
			index: 2,
			name: "bheise",
			name_cap: "bheise", cn_name_cap: "复古泳裤",
			name_simple: "bheise",
			variable: "bheise",
			integrity: 20,
			integrity_max: 20,
		...
		{
			index: 1,
			name: "daisy swimsuit bottoms",
			name_cap: "Daisy swimsuit bottoms", cn_name_cap: "雏菊泳衣下部",
			name_simple: "swimsuit",
			...
			cursed: 0,
			location: 0,
			iconFile: "daisy_swimsuit_bottoms.png",
			accIcon: 0
		},
	
		{
			index: 2,
			name: "children&#39;s swimsuit bottoms",
			name_cap: "children&#39;s swimsuit bottoms", cn_name_cap: "儿童泳衣下部",
			name_simple: "swimsuit",
			...
			cursed: 0,
			location: 0,
			iconFile: "kidsswimsuit_bottoms.png",
			accIcon: 0
		},
	
		{
			index: 3,
			name: "lace swimsuit bottom",
			name_cap: "lace swimsuit bottom", cn_name_cap: "花边泳装下部",
			name_simple: "swimsuit",
			...
			iconFile: 0,
			accIcon: 0,
			outfitSecondary: ["under_upper", "lace swimsuit"]
		},
	
		{
			index: 1,
			name: "mens_pantyhose",
			name_cap: "Mens_pantyhose",
			cn_name_cap: "男士连裤袜",
			variable: "mens_pantyhose",
			integrity_max: 20,
			integrity: 20,
			fabric_strength: 15,
			reveal: 700,
			...
			anus_exposed_base: 0,
			anus_exposed: 0,
			type: ["normal", "formal", "fetish", "naked"],
			set: "under_lower",
			gender: "m",
			femininity: -100,
			warmth: 1,
			cost: 1000,
			description: "嗯，是作者的恶趣味呢…",
			shop: ["clothing", "adult"],
			accessory: 0,
